using ADP_2024;
using ADP_2024.QuickSort;
using System.Diagnostics;

namespace ADP_2024_Test.QuickSort;
...
public sealed class QuickSortPerformanceTests
{
	...
	*/
	...
	public void TestQuickSortPerformanceNormal(int amount, int expectedAmount)
	{
		// Arrange
		...
		// Act
		QuickSortAlgorithm<int>.Quicksort(array, 0, array.Length - 1);
	...
	*/
	...
	[DataRow(100_000, 100_000)]
	[DataRow(1_000_000, 1_000_000)]
	public void TestQuickSortPerformanceBestCase(int amount, int expectedAmount)
	{
		// Arrange
		var array = new int[amount];
	...
	*/
	...
	[DataRow(100_000, 100_000)]
	[DataRow(1_000_000, 1_000_000)]
	public void TestQuickSortPerformanceWorstCase(int amount, int expectedAmount)
	{
		// Arrange
		var array = new int[amount];
